...
const TASK_META = {
  ...
  SWAP_AERODROME:   { emoji: null,  logo: "aerodrome", label: "Swap Aerodrome",  xp: 50  },
  SWAP_UNISWAP:     { emoji: null,  logo: "uniswap",   label: "Swap Uniswap",    xp: 50  },
  SWAP_JUMPER:      { emoji: null,  logo: "lifi",      label: "Swap Jumper",     xp: 50  },
  SWAP_RELAY:       { emoji: null,  logo: "relay",     label: "Swap Relay",      xp: 50  },
  BRIDGE_JUMPER:    { emoji: null,  logo: "lifi",      label: "Bridge Jumper",   xp: 50  },
  BRIDGE_RELAY:     { emoji: null,  logo: "relay",     label: "Bridge Relay",    xp: 50  },
};
          ...
          {events.map(ev => (
            <a key={ev.id} href={"https://basescan.org/tx/" + ev.txHash} target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-9 h-9 rounded-xl flex items-center justify-center text-lg flex-shrink-0"
                style={{ background: "rgba(0,82,255,0.1)", border: "1px solid rgba(0,82,255,0.2)", overflow: "hidden" }}>
                {ev.meta.logo
                  ? <ProtocolLogo id={ev.meta.logo} size={36} />
                  : ev.meta.emoji
                }
              </div>
